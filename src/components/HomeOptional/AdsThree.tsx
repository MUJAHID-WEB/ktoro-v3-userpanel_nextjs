...
const AdsThree = () => {
  ...
  return (
    <>
      <section className="container xl:flex lg:flex md:flex hidden flex-row flex-wrap gap-5 px-4 mt-8">
        <AdsComponent
          className="xl:w-[49%] lg:w-[48%] md:w-[48%] w-[100%] !h-[189px] aspect-[614/268]"
